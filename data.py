...
COSMIC_OBJECTS_PHASE5 = [
    ...
    {
        "id": str(uuid.uuid5(uuid.NAMESPACE_DNS, "luminous-fast-blue-optical-transient-2020")),
        "name": "AT 2020xnd",
        "category": "Luminous Fast Blue Optical Transient",
        "subtype": "Fast Blue Optical Transient with Circumstellar Interaction",
        "tags": ["lfbot", "fast-blue", "optical-transient", "new-discovery", "circumstellar-material"],
        "difficulty_level": "expert",
        "spatial": {
            "distance_from_earth": {"value": 5.5e9, "unit": "ly"},
            "coordinates": {"ra": "11h 21m 27.9s", "dec": "+41° 55' 04\""},
            "galaxy_reference": "Unknown host galaxy",
            "location": "Ursa Major constellation",
            "redshift": {"value": 0.73, "unit": "z"},
        },
        "physical": {
            "peak_luminosity": {"value": 1e44, "unit": "erg/s"},
            "rise_time": {"value": 4, "unit": "days"},
            "decline_rate": {"value": 0.2, "unit": "magnitudes/day"},
            "temperature": {"value": 20000, "unit": "K"},
            "explosion_energy": {"value": 1e51, "unit": "ergs"},
            "ejecta_mass": {"value": 1, "unit": "solar_masses"},
            "ejecta_velocity": {"value": 30000, "unit": "km/s"},
            "x-ray_luminosity": {"value": 1e42, "unit": "erg/s"},
        },
        "detailed_description": (
            "AT 2020xnd is a newly discovered Luminous Fast Blue Optical Transient (LFBOT) that represents "
            "one of the most extreme and mysterious explosions ever observed. Discovered in 2020 at a distance "
            "of 5.5 billion light-years in Ursa Major, this object reached a peak luminosity of 10^44 erg/s - "
            "equivalent to 100 billion suns - while rising to maximum brightness in only 4 days, making it one "
            "of the fastest evolving transients known. The explosion was extremely hot, with a temperature of "
            "20,000 K, and declined rapidly at a rate of 0.2 magnitudes per day. AT 2020xnd released a total "
            "energy of 10^51 ergs, equivalent to a supernova, but did so in a fraction of the time. The object "
            "ejected only 1 solar mass of material at velocities of 30,000 km/s, suggesting an extremely compact "
            "energy source. What makes AT 2020xnd particularly puzzling is its location - it appears in the "
            "intracluster space between galaxies, far from any obvious host. The transient also showed persistent "
            "X-ray emission with a luminosity of 10^42 erg/s, indicating ongoing high-energy processes. AT 2020xnd "
            "belongs to a new class of LFBOTs that challenge traditional supernova classification, possibly "
            "representing the merger of compact objects, the birth of a black hole, or interactions with dense "
            "circumstellar material. This discovery has opened new windows into stellar death and the physics "
            "of extreme explosions, demonstrating that the universe still holds surprises for astronomers."
        ),
        "scientific_facts": [
            "AT 2020xnd reached 10^44 erg/s, equivalent to 100 billion suns.",
            "The object rose to peak brightness in only 4 days.",
            "AT 2020xnd declined at 0.2 magnitudes per day.",
            "The explosion released 10^51 ergs of total energy.",
            "The object appears in intracluster space between galaxies.",
            "AT 2020xnd had a temperature of 20,000 K.",
            "The object ejected only 1 solar mass at 30,000 km/s.",
            "AT 2020xnd shows persistent X-ray emission.",
            "The object represents a new class of fast transients.",
            "AT 2020xnd challenges traditional supernova classification.",
            "The object was discovered in 2020 by the Zwicky Transient Facility.",
            "AT 2020xnd provides insights into extreme stellar explosions.",
        ],
        "formation_process": (
            "AT 2020xnd may have formed through several possible mechanisms: the merger of two compact objects "
            "(neutron stars or black holes), the collapse of a massive blue star, or the birth of a black hole "
            "with associated jet activity. Its location between galaxies suggests it may have been ejected from "
            "its host galaxy."
        ),
        "future_evolution": (
            "AT 2020xnd's optical emission has faded, but the X-ray source may persist for years. The remnant "
            "could be a newly formed black hole or neutron star that continues to inject energy into the "
            "surrounding medium."
        ),
        "related_objects": ["AT 2018cow", "ZTF 18abvkwla", "Fast Blue Optical Transients", "Supernovae"],
        "parent_system": "Intracluster Space",
        "child_objects": ["Relativistic Ejecta", "X-ray Source", "Shock Front"],
        "nasa_reference": "https://science.nasa.gov/astrophysics/focus-areas/black-holes-and-neutron-stars/",
    },
