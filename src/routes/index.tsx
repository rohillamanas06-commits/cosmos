...
function LandingPage() {
  ...
  return (
    <div className="w-full">
      ...
      {/* Hero Image Slideshow - Full screen */}
      <div className="relative w-full h-screen overflow-hidden">
        <img 
          src={SLIDESHOW_IMAGES[currentImageIndex]} 
          alt="Cosmos Slideshow" 
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-16 mb-16">
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a href="https://github.com/rohillamanas06-commits/cosmos" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white transition-colors" title="GitHub">
                ...
                <a href="https://www.linkedin.com/in/manas-rohilla-b73415338/" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white transition-colors" title="LinkedIn">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.225 0z"/></svg>
                </a>
                <a href="mailto:rohillamanas06@gmail.com" className="text-white/60 hover:text-white transition-colors" title="Gmail">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><a href="/terms" className="text-sm text-white/60 hover:text-white transition-colors">Terms of Service</a></li>
                <li><a href="/privacy" className="text-sm text-white/60 hover:text-white transition-colors">Privacy Policy</a></li>
                <li><a href="/cookies" className="text-sm text-white/60 hover:text-white transition-colors">Cookie Policy</a></li>
                <li><a href="/license" className="text-sm text-white/60 hover:text-white transition-colors">License</a></li>
              </ul>
            </div>
          </div>
