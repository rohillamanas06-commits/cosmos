          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-20 mb-12">
            ...
            <div>
              ...
              <div className="flex gap-4">
                ...
                <a href="#" className="text-white/60 hover:text-white transition-colors" title="Gmail">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><a href="#" className="text-sm text-white/60 hover:text-white transition-colors">License</a></li>
              </ul>
            </div>
          </div>
